    ...
    <section id="pricing" className="bg-gradient-to-br from-chocolate-deep via-chocolate-deep to-chocolate-medium/70 py-16 md:py-24 px-4">
      <div className="max-w-content mx-auto text-center">
        ...
        >
          ...
          <p className="font-body text-cream-warm/60 line-through text-lg mb-1">De R$ 97,00 por apenas</p>
          <p className="font-display font-extrabold text-6xl md:text-7xl text-gold-light mb-2 tracking-wide">R$ 37<span className="text-3xl">,90</span></p>
          <p className="font-body text-cream-warm/70 text-sm mb-8">
            Acesso vitalício · Sem mensalidade · Funciona pelo celular
          </p>

          <a
            href="https://www.ggcheckout.com/checkout/v2/lsgSmxg52rbY8UekF5Y3"
